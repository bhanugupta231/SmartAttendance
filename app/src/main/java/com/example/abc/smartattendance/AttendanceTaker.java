...
public class AttendanceTaker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadBtn = (Button) findViewById(R.id.btnuploadfromcamera);
        mImageView = (ImageView) findViewById(R.id.imgviewretrievefromfirebase);
...
/*********APPLYING FACE DETECTION USING GOOGLE VISION*************************/
                    ...
                    if(!faceDetector.isOperational()){
                        Toast.makeText(AttendanceTaker.this,"face detector can not be set up",Toast.LENGTH_LONG).show();
                        return;
...
*/
                       ...
                       Intent i1=new Intent(AttendanceTaker.this,AbsentActivity.class);
                        startActivity(i1);
                       ...
                       // System.out.println(score+"-----------------------------------------------");
                        ...
                        Toast.makeText(AttendanceTaker.this,"Kindly Try Again",Toast.LENGTH_LONG).show();
                        return;
                    }
